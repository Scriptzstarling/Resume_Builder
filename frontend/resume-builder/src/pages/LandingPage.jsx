        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              Build Your{" "}
              <span className="text-transparent bg-clip-text bg-[radial-gradient(circle,_#7182ff_0%,_#3cff52_100%)] bg-[length:200%_200%] animate_text-shine">
                Resume Effortlessly
              </span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Update your section with live preview and instant formatting.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Downlaod your resume instantly as a high-qality PDF with one
                click.
              </p>
            </div>
          </div>
